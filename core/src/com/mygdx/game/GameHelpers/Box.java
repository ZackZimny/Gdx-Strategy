...
/**
 * Creates a box with an x, y, width, and height and deals with collisions
 * between other Box objects, vectors, and x-y pairs.
 */
public class Box {
  protected float x, y;
   ...
   * @return boolean that states if the Box object contains the x and y position
   *         of the vector passed as a parameter
   */
  ...
  /**
   * Returns weather the Box object contains the x and y position of the
   * parameters
   * 
